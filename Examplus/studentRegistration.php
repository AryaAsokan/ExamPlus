...
return false;
  ...
  else if(f1.date.selectedIndex==0)
  {
  alert("Select a Date");
  f1.date.focus();
  return false;
  ...
  return false;
   ...
   else if(f1.year2.selectedIndex==0)
  {
  alert("Select year");
  f1.year2.focus();
  return false;
...
<div id="divBoxed" class="container">
    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
          ...
          <form name="f1"   method="post"  action="studentRegistration.php">
            <table width="821" border="0" align="center">
              <tr>
                <td width="121"><div align="left">Name:</div></td>
                <td width="690">
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="t3" id="t3" onKeyUp="return cUpper(this);" >&nbsp;
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <textarea name="t4" cols="" rows="" onKeyUp="return cUpper(this);"></textarea>&nbsp;
                </td>
              </tr>
              <tr>
...
if(isset($_POST['b1']))
{
 ...
 $j=$_POST['t5'];
 $k=$_POST['t6']; 
 $res="insert into studentdetails values('".$a."','".$b."','".$c."','".$d."','".$e."','".$l."','".$f."','".$h."','".$i."','".$j."','".$k."')";
