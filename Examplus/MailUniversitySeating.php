...
$q10="select examdate from university";
					$r10=mysql_query($q10);
					
//$z=mysql_num_rows($r10);
?>
<!DOCTYPE HTML>
<html>
<head>
        ...
        <div class="divPanel notop page-content">
            ...
            <!--Edit Main Content Area here-->
                <div class="span12" id="divMain">
					...
					<form name="f1" action="MailUniversitySeating.php" method="post">
					  <table width="703" border="0" align="center">
                      <tr><td width="206">Date:</td>
                        <td width="220"><select name="date">
						<option>2015-04-22</option>
						
					<?php
					
					/*while($darray=mysql_fetch_array($r10))
					{
					echo "<option>".$darray['examdate']."</option>"; 
					}*/
...
while($arr=mysql_fetch_array($re1))
	...
	$mail->Subject = 'Seating Arrangement for University Examination on: '.$t.' ';
$mail->Body    = 'Hi  '.$row['name'].' , <br>Your Seating Arrangement is for the University Examination is:<br>Department:'.$arr['department'].'<br>Room No:'.$arr['room_no'].'<br>Seat No:'.$seat.' ';
$mail->AltBody = '';
