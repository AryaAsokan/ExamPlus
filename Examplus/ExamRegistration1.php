...
if($sem=="S1&S2")
			...
			//echo "$arr1";
			  ...
			  {
			 // echo "sucess";
			 header("Location:ExamRegistration2.php");	
			 }		  
			  else
			 {
...
if(f1.semester.selectedIndex==0)
  ...
  else if(f1.examtype.selectedIndex==0)
  {
  alert("Select Exam category:");
  f1.examtype.focus();
  return false;
  }
}
        ...
        <div id="divMenuRight" class="pull-right">
          <div class="navbar">
            ...
            <div class="nav-collapse collapse">
						  ...
						  <li class="dropdown">
                            <a href="" class="dropdown-toggle">view<b class="caret"></b></a>
                            <ul class="dropdown-menu">
    ...
    <div class="divPanel notop page-content">
      <div class="row-fluid">
        ...
        <div class="span12" id="divMain">
          ...
          <form name="f1"   method="post"  action="ExamRegistration1.php">
