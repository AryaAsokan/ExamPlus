        ...
        <div class="divPanel notop page-content">
            ...
            <!--Edit Main Content Area here-->
                <div class="span12" id="divMain">
                   ...
                   <form name="f1" method="post" action="ScheduleTimetable0.php">
                     
                     <table width="828" height="145" border="0" align="center">
					 <tr>
                        <td width="140" height="31" >Series No:</td>
						<td width="678" height="31"><select name="seriesno">
						<option>First</option>
						<option>Second</option>
					   </select></td>
					   </tr>
                      <tr>
                        <td width="140" height="31">Department:</td>
                        <td width="678"><select name="Department">
...
$c5=$row1[5];
 ...
 $c7=$row1[7];
$c8=$row1[8];
 $q2="insert into `timetable` values('".$c."','".$c1."','".$c2."','".$c3."','".$c4."','".$c5."','".$c6."','".$c7."','".$c8."')";
 $r2=mysql_query($q2);
 $q3="insert into `examdate` values('".$c."','".$h."')";
 $r3=mysql_query($q3);
if($r2)
{
//echo "Success";
...
//echo "ERROR".mysql_error();
 ...
 $q2="insert into `timetable` values('".$arr."','".$c1."','".$c2."','".$c3."','".$c4."','".$c5."','".$c6."','0','0')";
 $r2=mysql_query($q2);
 $q3="insert into `examdate` values('".$arr."','".$h."')";
 $r3=mysql_query($q3);
if($r2)
{
//echo "Success";
