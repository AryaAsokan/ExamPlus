...
// $j=$_POST['t5'];
// $k=$_POST['t6']; 
 $res="delete  from  studentdetails where enrollment_no='".$a."'";
$result1=mysql_query($res);
$log="delete from login where user_name='".$a."'";
$result2=mysql_query($log);
if($result1)
{

header("location: studentDeletion.php");
        ...
        <div class="divPanel notop page-content">
            ...
            <!--Edit Main Content Area here-->
                <div class="span12" id="divMain">
                     <h1 align="center"> Student Deletion</h1>
          <form name="f1"   method="post"  action="studentDeletion.php">
