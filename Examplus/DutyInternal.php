            ...
            <!--Edit Main Content Area here-->
				...
				<h1 align="center"></h1>
                   ...
                   <form  action="UploadNotes.php" method="post" enctype="multipart/form-data" name="form1">
					...
					<tr><td>Date</td><td>Room No</td><td>Time</td></tr>
                      <?php
					 //$dep=$arr['department'];
					  $q1="select * from facultyallocation where faculty_id='".$_SESSION['u']."' and department='".$arr['department']."' order by date";
					  $r1=mysql_query($q1);
					  ...
					  //$date=$row['date'];
					 // echo "$date";
					  echo "<tr><td>".$row['date']."</td><td>".$row['room_no']."</td><td>".$row['time']."</td></tr>";
					  }
					  ?>
                    </table>
                  </form>
