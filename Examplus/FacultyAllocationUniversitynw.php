        ...
        <div class="divPanel notop page-content">
            ...
            <!--Edit Main Content Area here-->
                <div class="span12" id="divMain">
					...
					<p><strong>
					  <form name="f1" method="post" action="FacultyAllocationUniversitynw.php">
                        <p>&nbsp;</p>
...
for($r=0;$r<$j;$r++)
{
   ...
   for( $cnt = 0; $cnt < count($words); $cnt++ ) 
    $words[$cnt]; 
	$v="insert into facultyallocation values('".$faculty[$m]."','".$words[1]."','".$words[0]."','".$a."','0') ";
	$res2=mysql_query($v);
	...
	$v1="insert into facultyallocation values('".$faculty[$m]."','".$words[1]."','".$words[0]."','".$a."','0') ";
	$res2=mysql_query($v1);
	$res3="update faculty set status='1' where faculty_id='".$faculty[$m]."' ";
	$result2=mysql_query($res3);
	$m++;$n--;
