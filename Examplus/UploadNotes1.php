...
.style3 {font-size: 36px; color: #000000; }
-->
    </style>
</head>
<body id="pageBody">
        ...
        <div class="divPanel notop page-content">
            ...
            <!--Edit Main Content Area here-->
                <div class="span12" id="divMain">
                  <div align="center">
                    <p class="style2">&nbsp;</p>
                    <p class="style3">Upload Notes                  </p>
                  </div>
                  <form  action="UploadNotes1.php" method="post" enctype="multipart/form-data" name="form1">
                    <p>&nbsp;</p>
                    <table width="520" border="0" align="center">
                      <tr>
                        <td width="140">Department:</td>
                        <td width="370"><select name="department"   >
        ...
        <div class="divPanel">
            ...
            <div class="row-fluid">
              <div class="span3" id="footerArea1">
                ...
                <div class="span3" id="footerArea4"></div>
            </div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <p class="copyright">
                        Copyright © 2015 EXAM PLUS. All Rights Reserved.                    </p>

                    <p class="social_bookmarks">
                        <a href="#"><i class="social foundicon-facebook"></i> Facebook</a>
			<a href=""><i class="social foundicon-twitter"></i> Twitter</a>
			<a href="#"><i class="social foundicon-pinterest"></i> Pinterest</a>
			<a href="#"><i class="social foundicon-rss"></i> Rss</a>                    </p>
                </div>
            </div>
        </div>
    </div>
