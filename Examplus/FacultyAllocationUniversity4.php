                    ...
                    <div class="navbar">
                        ...
                        <div class="nav-collapse collapse">
                          ...
                          <ul class="dropdown-menu sub-menu">
                            ...
                            <li><a href="">Edit</a></li>
							<li><a href="TimetableScheduler.html">Delete</a></li>
                            </ul>
						  </li>
						    </ul>
                            </li>
...
<div><li class="active style1 style1" F>Welcome&nbsp; <?php echo $arr1['name']  ?>&nbsp;</li></div>
            ...
            <div class="span12">
                ...
                <div class="camera_full_width">
                    <div id="camera_wrap">
                        <div data-src="slider-images/s1.jpg" ><div class="camera_caption fadeFromBottom cap1">Add a slogan or feature here...</div></div>
						<div data-src="slider-images/s2.jpg" ><div class="camera_caption fadeFromBottom cap2">Add a slogan or feature here...</div></div>
        ...
        <div class="divPanel notop page-content">
            ...
            <!--Edit Main Content Area here-->
                <div class="span12" id="divMain">
					...
					<p><strong>
					  <form name="f1" method="post" action="FacultyAllocationUniversity4.php">
                        <p>&nbsp;</p>
...
if($rowcount<=0)
        {   
          $res1="update faculty set status='0' where department='PE' and designation='".$b."' ";	
	      $result1=mysql_query($res1);
		  $v="select faculty_id from faculty where department='PE' and designation='".$b."' and status='0' ";
          $res=mysql_query($v);
