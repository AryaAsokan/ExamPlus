    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
            ...
            <!--Edit Main Content Area here-->
				...
				<h1 align="center">Upload Marks</h1>
                    <form  action="UploadMark.php" method="post" enctype="multipart/form-data" name="f1">
                    <p>&nbsp;</p>
                    <table width="328" border="0" align="center">
                      <tr>
                        <td width="78">Department:</td>
                        <td width="240"><select name="department"   >
...
if(move_uploaded_file ($file_path,'Document/'.'Mark/'.$file_name))
$query=mysql_query("insert into marks (semester,department,name) values ('$s','$d','$file_name')");
if($query==true)
{
    echo "File Uploaded";
}
