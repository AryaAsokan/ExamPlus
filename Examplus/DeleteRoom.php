...
if(isset($_POST['b2']))
{
 $a=$_POST['t1'];
 $b=$_POST['department'];
 $res="delete  from  room where room_no='".$a."' and department='".$b."' ";
          ...
          <div class="navbar">
            ...
            <div class="nav-collapse collapse">
              <ul class="nav nav-pills ddmenu">
                ...
                <li class="dropdown"> <a  class="dropdown-toggle">Student <b class="caret"></b></a>
    ...
    <div class="contentArea">
      <div class="divPanel notop page-content">
        <div class="row-fluid">
          <!--Edit Main Content Area here-->
          <div class="span12" id="divMain">
            <h1 align="center">Delete Room</h1>
            <form name="f1" method="post" action="DeleteRoom.php">
              <table width="633" height="197" border="0" align="center">
                <tr>
                  <td height="25">Room No: </td>
                  <td><input type="text" name="t1" id="t1" value="<?php echo $arr['room_no']?>"></td>
                </tr>
                <tr>
                  <td width="175" height="56">Department:</td>
                  <td width="448"><select name="department">
                ...
                <tr>
                  ...
                  <td><input type="text" name="t2" id="t2" value="<?php echo $arr['max_seats']  ?>">                  </td>
                </tr>
                <tr>
                  <td height="31" valign="top">Min. Invigilators: </td>
                  <td><input type="text" name="t3" id="t3" value="<?php echo $arr['min_invigilators']  ?>"  >                  </td>
                </tr>
              </table>
              <div align="center">
